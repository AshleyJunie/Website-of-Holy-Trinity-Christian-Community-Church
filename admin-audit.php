...
<nav style="padding: 25px;">
   <div class="left">
    ...
    <ul>
     ...
     <li><a href="admin-audit.php" style="color:skyblue">AUDIT TRAILS</a></li>
  ...
  <a href="account-admin-register.php" class="sort-button">Sort Status:</a>
</div>
...
<table>
  ...
  <tbody>
    <tr>
      <td>2025-05-02</td>
      <td>12:32:10</td>
      <td colspan="2">Admin Ash has been logged in to the system</td>
      <td><button class="approve" onclick="document.getElementById('viewModal').style.display='block'">View</button></td>
    </tr>
  </tbody>
</table>
