...
<head>
    ...
    <title>Service - Funeral Service</title>
    <link rel="icon" type="image/x-icon" href="image/httc_main-logo.jpg">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="/HTCCC-SYSTEM/css/service-funeral.css?v=<?php echo filemtime($_SERVER['DOCUMENT_ROOT'].'/HTCCC-SYSTEM/css/service-funeral.css'); ?>">
    ...
    <style>
      /* Shared service layout + footer overlap fix */
      #service-preach {
        display: flex;
...
$image = "image/service-youth-revival.jpg";
...
<section id="service-preach">
    ...
    <div class="service-container">
        ...
        <div class="service-text">
            <h3 class="service-header-txt-preach">FUNERAL SERVICE</h3>
            ...
            <div class="background">
               <a href="appoint-page.php?service=FUNERAL%20SERVICE" class="read-more-btn-baptism">
                 APPOINT A SERVICE
               </a>
            </div>
        </div>
        ...
        <div class="service-image-container">
            <div class="service-image">
                <img src="<?php echo htmlspecialchars($image); ?>" alt="Funeral Service">
            </div>
        </div>
