...
<style>
            ...
            nav ul {
            display: flex;
            gap: 6rem; /* increased gap for large screen */
            font-size: 0.875rem;
            font-weight: 600;
...
<nav style="padding: 25px;">
   <div class="left">
    ...
    <ul>
     <li class="dashboard-btn" style="margin-left: 50px; font-weight: bold;"><a href="secretary_dashboard.php">DASHBOARD</a></li>
     <li class="dropdown">
            <a href="#service" style="color:skyblue;">REQUEST ▾</a>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="account-unbaptized.php">User Application</a></li>
            </ul>
        </li>
  ...
  <div class="container">
  <h2 class="header">END-USER ACCOUNTS LIST</h2>

  <div class="top-bar">
  <input type="text" placeholder="🔍 Search" class="search-box">
  <a href="account-admin-register.php" class="sort-button">Sort by:</a>
</div>
...
<table>
  ...
  <tbody>
    <?php
    $query = "SELECT * FROM individual_table";
