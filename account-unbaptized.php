...
<nav style="padding: 25px;">
    ...
    <ul>
     ...
     <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="account-unbaptized.php" style="color: skyblue;">Non-Baptise Individual Accounts</a></li>
            </ul>
        </li>
  ...
  <div class="container">
  <h2 class="header">NON-BAPTIZED ACCOUNTS LIST</h2>
...
<table>
  ...
  <tbody>
    <?php
    $query = "SELECT * FROM individual_table WHERE individual_baptised = 'No'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>
                <button class="Archive">Remove</button>
              </td>';
        echo '</tr>';
      }
    } else {
