...
<!-- ======================== SIDEBAR ======================== -->
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="navlink active" href="pastor-schedule-request.php"><i class="fas fa-calendar-plus"></i>Schedule Requests</a>
      <a class="navlink" href="pastor-prayer-request.php"><i class="fas fa-praying-hands"></i><span>Prayer Requests</span></a>
