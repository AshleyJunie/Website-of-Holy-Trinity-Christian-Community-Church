...
<head>
    ...
    <title>Service - Wedding</title>
    <link rel="icon" type="image/x-icon" href="image/httc_main-logo.jpg">
    <link rel="stylesheet" href="/HTCCC-SYSTEM/css/service-wedding.css?v=<?php echo filemtime($_SERVER['DOCUMENT_ROOT'].'/HTCCC-SYSTEM/css/service-wedding.css'); ?>">
    ...
    <!-- Inline CSS to match the baptism structure and prevent footer overlap -->
    <style>
      #service-preach {
        display: flex;
...
$image = "image/service-wedding.jpg";

// Build captions + detect first valid image
$captions = [];
foreach ($rows as $row) {
...
<section id="service-preach">
  ...
  <div class="service-container">
    ...
    <div class="service-text">
      <h3 class="service-header-txt-preach">WEDDING</h3>
      ...
      <div class="background">
        <a href="appoint-page.php?service=WEDDING" class="read-more-btn-wedding">
          BOOK A WEDDING
        </a>
      </div>
    </div>
    ...
    <div class="service-image-container">
      <div class="service-image">
        <img src="<?php echo htmlspecialchars($image); ?>" alt="Wedding Ceremony">
      </div>
    </div>
